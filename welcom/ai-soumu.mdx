...
![AI総務 Agent 手順 1](/images/ai-soumu/image1.png)

### 1.2 新しい Agent を作成する

左側メニューから「新Agent作成」に入り、表示された Agent 作成画面で「Agentワークフロー」と「最初から開始」を選択し、「確認」をクリックします。

![AI総務 Agent 手順 2](/images/ai-soumu/image2.png)

![AI総務 Agent 手順 3](/images/ai-soumu/image3.png)

![AI総務 Agent 手順 4](/images/ai-soumu/image4.png)

今回は従来版、つまりワークフロー形式で構築します。新しい Agent を作成する際に Agent 名を設定して保存します。本チュートリアルでは「AI総務 Agent」を構築します。

![AI総務 Agent 手順 5](/images/ai-soumu/image5.png)
...
![AI総務 Agent 手順 6](/images/ai-soumu/image6.png)

次に、AI総務 Agent の構築に進みます。まず、この Agent に求める input と output を整理します。

Agentify では、Agent の input としてテキスト、画像、ドキュメントを利用できます。

![AI総務 Agent 手順 7](/images/ai-soumu/image7.png)

手動トリガーでは、input による起動に加えて、ボタンを追加して Agent を起動できます。

![AI総務 Agent 手順 8](/images/ai-soumu/image8.png)

また、Agent を公開したあとにトリガーを設定することで、定期実行も可能です。

![AI総務 Agent 手順 9](/images/ai-soumu/image9.png)

![AI総務 Agent 手順 10](/images/ai-soumu/image10.png)

![AI総務 Agent 手順 11](/images/ai-soumu/image11.png)
...
![AI総務 Agent 手順 12](/images/ai-soumu/image12.png)

![AI総務 Agent 手順 13](/images/ai-soumu/image13.png)
...
参考資料のダウンロード先: [Google Drive](https://drive.google.com/file/d/1m0L5EDjCNVx1YShxk6dqht0AmxxmAXbM/view?usp=drive_link)

![AI総務 Agent 手順 14](/images/ai-soumu/image14.png)

![AI総務 Agent 手順 15](/images/ai-soumu/image15.png)

![AI総務 Agent 手順 16](/images/ai-soumu/image16.png)

解析ステータスが成功と表示されたら、ナレッジベースの準備は完了です。ファイルをクリックするとチャンクの詳細も確認できます。

![AI総務 Agent 手順 17](/images/ai-soumu/image17.png)
...
![AI総務 Agent 手順 18](/images/ai-soumu/image18.png)

![AI総務 Agent 手順 19](/images/ai-soumu/image19.png)
...
![AI総務 Agent 手順 20](/images/ai-soumu/image20.png)
...
![AI総務 Agent 手順 21](/images/ai-soumu/image21.png)
...
![AI総務 Agent 手順 22](/images/ai-soumu/image22.png)
...
![AI総務 Agent 手順 23](/images/ai-soumu/image23.png)
...
![AI総務 Agent 手順 24](/images/ai-soumu/image24.png)

![AI総務 Agent 手順 25](/images/ai-soumu/image25.png)
...
![AI総務 Agent 手順 26](/images/ai-soumu/image26.png)

![AI総務 Agent 手順 27](/images/ai-soumu/image27.png)
...
![AI総務 Agent 手順 28](/images/ai-soumu/image28.png)

![AI総務 Agent 手順 29](/images/ai-soumu/image29.png)

接続が完了すると、現在のロジックではナレッジベースに関連情報が存在する場合のみ LLM モジュールが起動することを確認できます。

![AI総務 Agent 手順 30](/images/ai-soumu/image30.png)

そのため、関連情報が存在しない場合にもユーザーへ通知できるよう、戻り値を設定します。

![AI総務 Agent 手順 31](/images/ai-soumu/image31.png)

![AI総務 Agent 手順 32](/images/ai-soumu/image32.png)

保存後にテストします。テスト結果を分かりやすく確認するため、Agent 設定の左側メニューからナレッジベースの引用元表示を有効にします。

![AI総務 Agent 手順 33](/images/ai-soumu/image33.png)

![AI総務 Agent 手順 34](/images/ai-soumu/image34.png)

今回のテスト input: 有給は何日前までに申請すればいいですか？

![AI総務 Agent 手順 35](/images/ai-soumu/image35.png)

角のマークをクリックすると、参照されたファイルと引用元を確認できます。

![AI総務 Agent 手順 36](/images/ai-soumu/image36.png)

![AI総務 Agent 手順 37](/images/ai-soumu/image37.png)
...
![AI総務 Agent 手順 38](/images/ai-soumu/image38.png)
...
![AI総務 Agent 手順 39](/images/ai-soumu/image39.png)

![AI総務 Agent 手順 40](/images/ai-soumu/image40.png)
...
![AI総務 Agent 手順 41](/images/ai-soumu/image41.png)

![AI総務 Agent 手順 42](/images/ai-soumu/image42.png)

それぞれのコンポーネントで、検索対象のデータベースを設定します。

![AI総務 Agent 手順 43](/images/ai-soumu/image43.png)

![AI総務 Agent 手順 44](/images/ai-soumu/image44.png)

![AI総務 Agent 手順 45](/images/ai-soumu/image45.png)

接続が完了したら、出力結果をテストします。

![AI総務 Agent 手順 46](/images/ai-soumu/image46.png)

![AI総務 Agent 手順 47](/images/ai-soumu/image47.png)

自然言語で回答したい場合は、データベース検索モジュールの後ろに LLM モジュールを追加して応答を整形します。この場合、データベース検索モジュール自体の出力は閉じても構いません。

![AI総務 Agent 手順 48](/images/ai-soumu/image48.png)
...
![AI総務 Agent 手順 49](/images/ai-soumu/image49.png)
...
![AI総務 Agent 手順 50](/images/ai-soumu/image50.png)

ユーザー入力モジュールのボタン追加方法と実際の操作イメージは以下です。

![AI総務 Agent 手順 51](/images/ai-soumu/image51.png)

![AI総務 Agent 手順 52](/images/ai-soumu/image52.png)
...
![AI総務 Agent 手順 53](/images/ai-soumu/image53.png)

同時に、データベース更新モジュールにも接続します。

![AI総務 Agent 手順 54](/images/ai-soumu/image54.png)
...
![AI総務 Agent 手順 55](/images/ai-soumu/image55.png)

テスト入力: 営業部の田中です。新入社員用にノートPCを1台申請したいです。6月1日から使いたいです。

![AI総務 Agent 手順 56](/images/ai-soumu/image56.png)

![AI総務 Agent 手順 57](/images/ai-soumu/image57.png)

![AI総務 Agent 手順 58](/images/ai-soumu/image58.png)
...
本チュートリアルの Agent 全体ワークフローのリソースコード: [Google Drive](https://drive.google.com/file/d/166XjIkwEr6KRtryw1b4gqYogjCkAFpAb/view?usp=sharing)

ダウンロード後、ファイル内のコードをインポートして利用できます。学習用のサンプルのため、ナレッジベースとデータベースのテストファイルは別途手動で設定してください。

![AI総務 Agent 手順 59](/images/ai-soumu/image59.png)
